...
class HeightAdapter internal constructor(view: View) : RecyclerView.Adapter<HeightAdapter.ViewHolder>() {
    private val tall: TextView = view.findViewById(R.id.tall)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.number_list_item_cm, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.parentLayout.setOnClickListener {
            ...
            tall.text = (position + size).toString()
        }
    }
